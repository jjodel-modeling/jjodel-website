...
**Nota**: eseguito il 6 settembre su deroga esplicita di Alfonso alla clausola "solo il 15 settembre"; i sottodomini non erano ancora commutati, da verificare prima del merge e del push. Il sottotitolo di /whats-new/ conservava "Jjodel 3.0 will be released on 15 September 2026" nella prima frase, fuori dallo scope del prompt: corretto su richiesta di Alfonso con un terzo commit, la data ora compare solo nella frase di chiusura.
